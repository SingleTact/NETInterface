...
namespace SingleTact_Demo
{
   public partial class GUI : Form
   {
      ...
      public GUI()
      {
         ...
         //SetBaselineButton_Click(this, null);
      ...
      private void PopulateSetComboBoxes()
      {
         ...
         for (int i = 0; i < 12; i++)
            i2cAddressInputComboBox_.Items.Add("0x" + (i + 4).ToString("00"));
      ...
      void CreateStripChart()
      {
         ...
         box.Fill = new Fill(Color.FromArgb(200, Color.LightGreen), Color.FromArgb(200, Color.LightGreen), 45.0F);
      ...
      public void AddData(double time, double[] measurements)
      {
         ...
         while (graphPane.CurveList.Count < measurements.Length)
         {
            ...
            LineItem myCurve = new LineItem(name, dataBuffer_.data[graphPane.CurveList.Count], Color.Blue, SymbolType.None, 3.0f);
